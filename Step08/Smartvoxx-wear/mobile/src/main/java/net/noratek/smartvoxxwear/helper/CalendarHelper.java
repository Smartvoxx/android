package net.noratek.smartvoxxwear.helper;
...
public class CalendarHelper {
    ...
    public Long addEvent(Talk talk) {
        ...
        //String title = "[" + mContext.getText(R.string.devoxx_conference).toString() +"] ";
        //title += talk.getTitle();
        ...
        // attach reminders to the event (5, 10 and 15 minutes)
        addReminderAlarm(talk.getTalkId(), eventId, event, 5);
        //addReminderAlarm(talk.getTalkId(), eventId, event, 10);
    ...
    private void addReminderAlarm(String talkId, Long eventId, ContentValues event, Integer threshold) {
        ...
        // TODO restore this line before RELEASE
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.MINUTE, 6);
        Date startDate = calendar.getTime();
        //trigger.setTime(new Date(event.getAsLong("dtstart")));
        trigger.setTime(startDate); // TO BE REMOVED BEFORE RELEASE
    ...
    public String getTitle(Long eventId) {
        ...
        Cursor cursor = mContext.getContentResolver().query(eventsUri, new String[]{"title"}, "_id=" + eventId, null, null);
...
*/
    ...
    public Talk getTalkByTitleAndTime(String title, Long startTime, Long endTime) {
        ...
        // Todo uncomment following line for the release
