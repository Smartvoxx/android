...
public class WearService extends WearableListenerService {
    ...
    private void retrieveFavorite(byte[] inputData) {
        ...
        // Retrieve the Talk
        Talk talk = new Talk();
        talk.setTalkId(inputMap.getString("talkId"));
        ...
        sendFavorite(talk.getTalkId(), eventId);
    }
    ...
    private void removeFavorite(byte[] inputData) {
        ...
        sendFavorite(talk.getTalkId(), 0L);
    }
    ...
    private void sendTalk(Talk talk) {
        final PutDataMapRequest putDataMapRequest = PutDataMapRequest.create(Constants.TALK_PATH + "/" + talk.getTalkId());
