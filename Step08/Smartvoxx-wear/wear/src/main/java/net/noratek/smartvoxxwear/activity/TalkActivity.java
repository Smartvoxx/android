...
public class TalkActivity extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, DataApi.DataListener {
    ...
    public void onDataChanged(DataEventBuffer dataEventBuffer) {
        ...
        for (DataEvent event : dataEventBuffer) {
            ...
            if (event.getType() == DataEvent.TYPE_CHANGED && event.getDataItem().getUri().getPath().startsWith(Constants.TALK_PATH + "/" + talkId)) {
            ...
            if (event.getType() == DataEvent.TYPE_CHANGED && event.getDataItem().getUri().getPath().startsWith(Constants.FAVORITE_PATH + "/" + talkId)) {
